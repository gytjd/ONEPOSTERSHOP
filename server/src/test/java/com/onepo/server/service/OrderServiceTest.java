...
public class OrderServiceTest {
    ...
    public void 장바구니주문취소() throws Exception {
        ...
        Long findCartC = wishService.addCart(member,item3,4);
        ...
        Long memberOrderId = orderService.order_Wish(member, delivery);
        Long memberOrderId2 = orderService.order_Wish(member2, delivery2);

        orderService.order_Cancel(member,memberOrderId);
    }
}